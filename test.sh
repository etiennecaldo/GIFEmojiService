myDate=`date`
echo $myDate
curl -H "Content-Type: application/json" -H "X-Auth-User: 1234" -X POST -d '}' http://localhost:8080/api/gifs/favorite 
curl -H "Content-Type: application/json" -H "X-Auth-User: 1234" -X POST -d '{"date":"tata"}' http://localhost:8080/api/gifs/favorite 
curl -H "Content-Type: application/json" -H "X-Auth-User: 1234" -X POST -d '{"date":"tata"}' http://localhost:8080/api/gifs/favorite 
curl -H "Content-Type: application/json" -H "X-Auth-User: 1234" -X POST -d '{"date":"tata"}' http://localhost:8080/api/gifs/favorite 
